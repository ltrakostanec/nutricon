 ...
 * @author Leon
 */
public class JDialogPrikazMjerenja extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPrikazMjerenja
     */
    public JDialogPrikazMjerenja(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        prikazKorisnika();     
    }
    ...
    private void initComponents() {
        ...
        btnPrikaziIzracunMjerenja = new javax.swing.JButton();
        ...
        btnIzbrisi.setText("Izbriši mjerenje");
        ...
        btnPrikaziIzracunMjerenja.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        btnPrikaziIzracunMjerenja.setText("Prikaži izračun mjerenja");
        btnPrikaziIzracunMjerenja.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPrikaziIzracunMjerenjaActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(btnPrikaziIzracunMjerenja)
                        .addGap(192, 192, 192))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnIzbrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzbrisiActionPerformed
        ...
        int index = tablePrikazMjerenja.getSelectedRow();
        if (index>-1) {
            //DefaultTableModel tableModel = (DefaultTableModel)tablePrikazMjerenja.getModel();
            tablePrikazMjerenja.getModel();
            int id = (Integer)modelPrikazMjerenja.getValueAt(index, 0);
            if (DBspajanje.izbrisiMjerenje(id)){
                JOptionPane.showMessageDialog(null, "Mjerenje je obrisano",
                    "Brisanje mjerenja korisnika", JOptionPane.PLAIN_MESSAGE);   
            } else {
                JOptionPane.showMessageDialog(null, "Greška kod brisanja. "
                        + "Mjerenje nije obrisano", "Brisanje mjerenja korisnika",
    ...
    private void btnPrikaziIzracunMjerenjaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrikaziIzracunMjerenjaActionPerformed
        // TODO add your handling code here:
        ...
        if(indexOdabranogMjerenja>-1){
            ...
            JDialogIzracunMjerenja dlgIzracunMjerenja = new JDialogIzracunMjerenja(null,true);
            dlgIzracunMjerenja.postaviMjerenje(mjerenje);
            dlgIzracunMjerenja.postaviKorisnika(korisnik);
            dlgIzracunMjerenja.prikaziMjerenje();
            ...
            JOptionPane.showMessageDialog(null, "Odaberite mjerenje korisnika.\nMjerenje korisnika mora biti odabrano!"
               ,"Izračun mjerenja korisnika", JOptionPane.ERROR_MESSAGE);
        }
        }else{
    ...
    }//GEN-LAST:event_btnPrikaziIzracunMjerenjaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogPrikazMjerenja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogPrikazMjerenja dialog = new JDialogPrikazMjerenja(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton btnPrikaziIzracunMjerenja;
